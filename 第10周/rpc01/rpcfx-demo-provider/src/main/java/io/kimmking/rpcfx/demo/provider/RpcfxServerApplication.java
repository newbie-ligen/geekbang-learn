...
import io.kimmking.rpcfx.demo.provider.service.OrderServiceV2Impl;
import io.kimmking.rpcfx.demo.provider.service.UserServiceImpl;
import io.kimmking.rpcfx.demo.provider.service.UserServiceV2Impl;
...
//		registerService(client, orderService);
	...
	@Bean(name = "io.kimmking.rpcfx.demo.api.UserServiceV2")
	public UserService createUserServiceV2(){
		return new UserServiceV2Impl();
	}

	@Bean(name = "io.kimmking.rpcfx.demo.api.OrderServiceV2")
	public OrderService createOrderServiceV2(){
		return new OrderServiceV2Impl();
	}
